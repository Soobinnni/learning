...
const ArticleHeader = ({ title, createdAt, onDeleteClick, onEditClick }) => {
    ...
    return (
        <>
            ...
            <div className="m-auto w-app text-primary-800 flex flex-col gap-4">
                ...
                <ArticleDetailIconMenu onEditClick = {onEditClick} onDeleteClick={onDeleteClick} />
            </div>
            <div className="transform rotate-180">
                <WaveDivider color="rgba(255, 255, 255, 0.5)" height={80} />
            </div>
        </>
    );
}
