...
public class ConsumerProducerExample {
  ...
  // lock으로부터 여러 개의 컨디션 객체를 생성할 수 있다.
  // 여러 컨디션으로 각각의 await -> signal 을 관리할 수 있게 된다.
  private final Condition notEmpty = lock.newCondition(); // 소비자를 대기하도록 할 때 쓰일 조건변수
  private final Condition notFull = lock.newCondition(); // 생산자를 대기하도록 할 때 쓰일 조건변수
